...
<section id="tech-stack">
  <h1 class="heading">Technologies and Frameworks</h1>
  <div class="stack mt-4">
    ...
    <i class="devicon-nextjs-original colored" />
    ...
    <i class="devicon-sequelize-plain colored" />
    <i class="devicon-flutter-plain colored" />
    ...
    <i class="devicon-yarn-plain colored" />
    <i class="devicon-unity-original colored" />
  </div>
</section>
